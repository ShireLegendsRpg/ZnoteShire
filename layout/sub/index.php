...
<div class="head">Server Info</div>
    <p>&emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp;&emsp; &emsp; &emsp; &emsp; Informações do Servidor</p>

        <p>
          &emsp; &emsp;  &emsp; &emsp; &emsp; &emsp; &emsp;  &emsp; &emsp; &emsp;&emsp; &emsp;  &emsp; Bem-vindo ao nosso mais novo jogador:
        ...
        <p>
            &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp;  O melhor jogador é:
                <a href="characterprofile.php?name=<?php echo $data['bestPlayer']['name']; ?>">
                 <strong><?php echo $data['bestPlayer']['name']; ?></strong>
                </a> level: <strong><?php echo $data['bestPlayer']['level']; ?> </strong> Parabéns!

        </p>


        <p>
        &emsp; &emsp;&emsp; &emsp; &emsp; &emsp; &emsp; &emsp;&emsp; &emsp;  Nós temos <b><?php echo $data['accountCount']; ?></b> contas em nossa base de dados, <b><?php echo $data['playerCount']; ?></b> personagens, e <b><?php echo $data['guildCount']; ?></b> guilds
        </p>
