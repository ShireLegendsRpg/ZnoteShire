...
<p>Aqui você encontrará todas as informações básicas sobre <b><?php echo $config['site_title']; ?></b></p>

<?php
    echo $stagesData;
if (($stagesData && isset($stagesData['enabled']) && $stagesData['enabled']) || (isset($luaConfig['experienceStages']) && $luaConfig['experienceStages'] === true)):
    $stages = true;

    // Adicionando o log para o console
?>
    <h2>Server rates</h2>
...
<?php else: ?>
	<p>O administrador do servidor ainda não importou as informações do servidor para esta página.</p>
<?php endif;
